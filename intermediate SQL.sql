...
-- Debug this code
SELECT certification /* SPELLING ERROR */
FROM films
LIMIT 5;

-- Debug this code
SELECT film_id, imdb_score, num_votes /* NO COMMAS BETWEEN COLUMNS */
FROM reviews;

-- Debug this code
SELECT COUNT(birthdate) AS count_birthdays /* SPELLING ERROR */
FROM people;
...
-- NOT STANDARD QUERY NAME
/* i.e. if field name is facebook likes in ecommerce table you can query it by
...
-- Filter for language to be in Spanish or English
